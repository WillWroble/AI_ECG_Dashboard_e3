...
def preprocess_ecg(ecg, sample_rate, leads, new_freq=None, new_len=None, scale=1,
    ...
    print(f"Max value AFTER powerline filter: {np.max(np.abs(ecg_nopowerline[3]))}")
    print(f"--------------------------")
    # Resample
    ...
    print(f"Max value AFTER resample/rescale: {np.max(np.abs(ecg_rescaled[3]))}")
    print(f"--------------------------")
    # Add leads if needed
    ...
    print(f"Max value AFTER reshape: {np.max(np.abs(ecg_reshaped[3]))}")
    print(f"--------------------------")
