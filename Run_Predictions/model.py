from tensorflow.keras.layers import (
    Normalization, Input, Conv1D, MaxPooling1D, Dropout, BatchNormalization, Activation, Add, Flatten, Dense)
...
def get_model(n_classes, kernel_size, last_layer='sigmoid'):
    kernel_initializer = 'he_normal'
    signal = Input(shape=(2048, 12), dtype=np.float32, name='signal')
    x = signal
    #x = Normalization(axis=2)(x)
    ...
    x, y = ResidualUnit(128, 192, kernel_size=kernel_size,
